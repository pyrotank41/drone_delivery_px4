...
async def run():
    global _aruco_img_pub, _global_position, PRESITION_LAND, _x_error, _y_error, _altitude, id_to_find, id_marker_size, _yaw_deg
    ...
    async for position in drone.telemetry.position():
        ...
        # print(f"Current alt {position.relative_altitude_m}")\
        ...
        if position.relative_altitude_m < 0.5:
            ...
            if(position.relative_altitude_m < 5):
                id_to_find = 2
                id_marker_size = 15
